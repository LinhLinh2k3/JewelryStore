...
function layout_change(layout) {
  ...
  if (layout == 'dark') {
    ...
    if (document.querySelector('.invoice-logo')) {
      document.querySelector('.invoice-logo').setAttribute('src', '~/Content/assets/images/logo-white.svg');
    }
    if (document.querySelector('.auth-form .card-footer a img')) {
      document.querySelector('.auth-form .card-footer a img').setAttribute('src', '~/Content/assets/images/logo-white-sm.svg');
    }
    ...
    dark_flag = false;
    if (document.querySelector('.invoice-logo')) {
      document.querySelector('.invoice-logo').setAttribute('src', '~/Content/assets/images/logo-dark.svg');
    }
    if (document.querySelector('.auth-form .card-footer a img')) {
      document.querySelector('.auth-form .card-footer a img').setAttribute('src', '~/Content/assets/images/logo-dark-sm.svg');
    }
    var control = document.querySelector('.theme-layout .btn.active');
    if (control) {
      document.querySelector('.theme-layout .btn.active').classList.remove('active');
